...
// Sets default values
ADieRobotBuildingComponentBase::ADieRobotBuildingComponentBase()
{
...
void ADieRobotBuildingComponentBase::BeginPlay()
{
	Super::BeginPlay();
...
void ADieRobotBuildingComponentBase::SetupProxyCollisionHandling()
{
	if (bIsProxy == true)
	{
		...
		if (CheckBuildingComponentOverlapCollisionBox)
		{
			...
			/*CheckBuildingComponentOverlapCollisionBox->OnComponentBeginOverlap.AddDynamic(this, 
				&ADieRobotBuildingComponentBase::HandleOverlappedBuildingComponent);*/
			CheckBuildingComponentOverlapCollisionBox->OnComponentHit.AddDynamic(this, &ADieRobotBuildingComponentBase::HandleHitBuildingComponent);
			/*CheckBuildingComponentOverlapCollisionBox->OnComponentEndOverlap.AddDynamic(this, 
				&ADieRobotBuildingComponentBase::HandleEndOverlappedBuildingComponent);*/
...
void ADieRobotBuildingComponentBase::CreateSnapPoints()
{
	if (StaticMesh)
	{
...
void ADieRobotBuildingComponentBase::CreateQuadrantComponents()
{
	if (StaticMesh)
	{
...
void ADieRobotBuildingComponentBase::HandleDeletionOfBuildable()
{
...
void ADieRobotBuildingComponentBase::DeleteAllAttachments()
{
...
void ADieRobotBuildingComponentBase::DestroyAllAttachments()
{
	if (AttachedBuildingComponents.Num() > 0)
	{
...
void ADieRobotBuildingComponentBase::HandleOverlappedBuildingComponent(
	UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex,
	bool bFromSweep, const FHitResult& SweepResult)
{
	ADieRobotBuildingComponentBase* OtherOverlappedBuildingComponent = Cast<ADieRobotBuildingComponentBase>(OtherActor);
...
void ADieRobotBuildingComponentBase::HandleHitBuildingComponent(
...
void ADieRobotBuildingComponentBase::HandleEndOverlappedBuildingComponent(
	UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex)
{
	ADieRobotBuildingComponentBase* OverlappedBuildingComponent = Cast<ADieRobotBuildingComponentBase>(OtherActor);
