...
#include "DieRobotPlayerController.generated.h"
 ...
 */
UCLASS()
class DIEROBOT_API ADieRobotPlayerController : public APlayerController
{
	GENERATED_BODY()
...
protected:
	...
	/*DieRobot References*/
	UPROPERTY(BlueprintReadOnly)
	ADieRobotPlayableCharacter* DieRobotCharacter;
	UPROPERTY(BlueprintReadOnly)
	UCharacterMovementComponent* DieRobotCharacterMovementComponent;
	
	/*Camera Controls*/
	UPROPERTY(BlueprintReadOnly)
	USpringArmComponent* DieRobotCharacterSpringArmComponent;
