...
#include "DieRobotBuildingComponentBase.generated.h"
...
UCLASS()
class DIEROBOT_API ADieRobotBuildingComponentBase : public ABuildableBase
{
	GENERATED_BODY()

public:
	
	ADieRobotBuildingComponentBase();
