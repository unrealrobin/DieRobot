...
#include "DieRobotHUDBase.generated.h"
 ...
 */
UCLASS()
class DIEROBOT_API ADieRobotHUDBase : public AHUD
{
	GENERATED_BODY()
...
public:
	...
	/*
	 * Widget Classes
	 * Set in BP on BP_DieRobotHUDBase
	 */
	...
	UPROPERTY(VisibleAnywhere)
	TObjectPtr<ADieRobotPlayerController> DieRobotPlayerController;
