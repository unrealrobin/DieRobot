...
#include "DieRobotWeaponRangedBase.generated.h"

class ADieRobotCharacterBase;
class USoundCue;

UCLASS()
class DIEROBOT_API ADieRobotWeaponRangedBase : public ADieRobotWeaponBase
{
	GENERATED_BODY()

public:
	ADieRobotWeaponRangedBase();
	...
	TSubclassOf<ADieRobotProjectileBase> ProjectileType;
