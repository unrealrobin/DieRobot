 ...
 */
UCLASS()
class DIEROBOT_API ADieRobotGameModeBase : public AGameModeBase
{
	GENERATED_BODY()
...
public:
	...
	/*Character*/
	UPROPERTY()
	ADieRobotPlayableCharacter* DieRobotCharacter = nullptr;
	
	/* Seeda Details */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Classes")
	TSubclassOf<ADieRobotSeeda> SeedaClass;
